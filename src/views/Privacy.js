...
const Privacy = () => {
  return (
    <>
      ...
      <p>
        My World Map (&quot;we&quot;, &quot;our&quot;, &quot;us&quot;) operates
        the website myworldmap.org (the &quot;Service&quot;). This page informs
      ...
      <p>
        ...
        explains the types of personal information we collect, how we use that
        information, who we share it with, how we protect that information, and
        your legal rights in relation to your information.{" "}
      </p>
      <p>
        We are accounts/signuped in the United Kingdom and our principal place
        of business is in the UK.
      </p>
      <p>
      ...
      <p>
        <em>Personal Data</em>: While using our Service, we may ask you to
      ...
      <p>
        We will not store your passwords in plain text and take measures to
        secure them appropriately.
      </p>
      <p>
        <em>Usage Data</em>: We also collect information about how the Service
      ...
      <p>
        <em>Location Data</em>: In order to provide the functionality of the
        Service, we will ask for information about countries and points you have
        visited. We will only collect this information with your explicit
        consent.
      </p>
      <p>
      ...
      <p>
        ...
        to any applicable legal requirements, including legal and ethical
